                            ...
                            <tr data-product-id="<?php echo $product_id; ?>" 
                                ...
                                <td>
                                    ...
                                    <div class="woo-limit-product-meta">
                                        ...
                                        <?php if (!empty($category_names)): ?>
                                            <span><strong>Category:</strong> <?php echo esc_html(implode(', ', $category_names)); ?></span>
                                        <?php endif; ?>
                                ...
                                <td>
                                    <div class="woo-limit-numbers-display">
                                        <div class="woo-limit-numbers-toggle" onclick="toggleNumbers(this, 'available-<?php echo $product_id; ?>')">
                                ...
                                <td>
                                    <div class="woo-limit-numbers-display">
                                        <div class="woo-limit-numbers-toggle" onclick="toggleNumbers(this, 'sold-<?php echo $product_id; ?>')">
                                            <span class="toggle-icon dashicons dashicons-arrow-down-alt2"></span>
                                                ...
                                                <?php foreach ($sold_details as $detail):?>
                                                    <div class="number-item">
                                                        ...
                                                        <?php if ($detail['order_status'] === 'ORDERED' && $detail['order_link'] !== 'N/A'): ?>
                                                            - <a href="<?php echo esc_url($detail['order_link']); ?>" target="_blank" class="order-link">
                                ...
                                <td>
                                    <div class="woo-limit-progress">
                                        <div class="woo-limit-progress-bar sold" style="width: <?php echo $sold_percentage; ?>%"></div>
                                    </div>
                                    <small><?php echo $sold_percentage; ?>% sold</small>
                                </td>
                                                                 <td>
                                     <a href="<?php echo admin_url('post.php?post=' . $product_id . '&action=edit'); ?>" class="woo-limit-edit-btn">
                    ...
                    <tr>
                        <td colspan="7">
                            <div class="woo-limit-empty-state">
                                ...
                                <p>You haven't set up any limited edition products yet. Create your first limited product to see reports here.</p>
                            </div>
                        </td>
                    </tr>
                    <?php
...
function exportReport() {
    ...
    let csv = 'Product Name,SKU,Category,Product Type,Number Range,Total Numbers,Available Count,Sold Count,Sold Percentage,Available Numbers,Sold Numbers\n';
    ...
    rows.forEach(row => {
        ...
        if (cells.length >= 6) {
            ...
            // Get detailed numbers
            const availableNumbers = cells[3].querySelector('.woo-limit-numbers-list')?.textContent.trim() || '';
            const soldNumbers = cells[4].querySelector('.woo-limit-numbers-list')?.textContent.trim() || '';
            
            csv += `"${productName}","${sku}","${category}","${type}","${range}","${totalNumbers}","${availableCount}","${soldCount}","${soldPercentage}%","${availableNumbers}","${soldNumbers}"\n`;
        }
    });
...
function generateExcelReport() {
    ...
    const excelData = [
        ['Product Name', 'SKU', 'Category', 'Product Type', 'Number Range', 'Total Numbers', 'Available Count', 'Sold Count', 'Sold Percentage', 'Available Numbers', 'Sold Numbers']
    ];
    ...
    rows.forEach(row => {
        ...
        if (cells.length >= 6) {
            ...
            excelData.push([
                productName, sku, category, type, range, totalNumbers, availableCount, soldCount, soldPercentage + '%', availableNumbers, soldNumbers
            ]);
        }
    });
