        ...
        (r.prototype = {
            initialize: function () {
                ...
                t.element.setAttribute("autocomplete", "off"),
                    (t.noSuggestionsContainer = d(
                        ...
                        .get(0)),
                    (t.suggestionsContainer = r.utils.createNode(
                        s.containerClass
                    )),
                    (e = d(t.suggestionsContainer)).appendTo(
                        s.appendTo || "body"
                    ),
            ...
            setOptions: function (e) {
                ...
                (t.isLocal = Array.isArray(e.lookup)),
                    t.isLocal &&
                        (e.lookup = t.verifySuggestionsFormat(e.lookup)),
                    (e.orientation = t.validateOrientation(
                        e.orientation,
                        "bottom"
                    )),
            ...
            fixPosition: function () {
                var e,
                    ...
                    u,
                    l = this,
                    r = d(l.suggestionsContainer),
                    c = r.parent().get(0);
                (c !== document.body && !l.options.forceFixPosition) ||
                    ((i = l.options.orientation),
                    (e = r.outerHeight()),
                    (t = l.el.outerHeight()),
                    (n = { top: (u = l.el.offset()).top, left: u.left }),
                    "auto" === i &&
                        ((a = d(window).height()),
                        (o = -(s = d(window).scrollTop()) + u.top - e),
                        (s = s + a - (u.top + t + e)),
                        (i = Math.max(o, s) === o ? "top" : "bottom")),
                    (n.top += "top" === i ? -e : t),
                    c !== document.body &&
                        ((a = r.css("opacity")),
                        l.visible || r.css("opacity", 0).show(),
                        (u = r.offsetParent().offset()),
                        (n.top -= u.top),
                        (n.top += c.scrollTop),
                        (n.left -= u.left),
                        l.visible || r.css("opacity", a).hide()),
                    "auto" === l.options.width &&
                        (n.width = l.el.outerWidth() + "px"),
                    r.css(n));
            },
            ...
            getQuery: function (e) {
                ...
                return t ? (t = e.split(t))[t.length - 1].trim() : e;
            },
            ...
            hide: function () {
                ...
                "function" == typeof e.options.onHide &&
                    e.visible &&
            ...
            suggest: function () {
                var e, s, i, a, u, l, t, n, o, r, c, g;
                this.suggestions.length
                    ? ((s = (e = this).options),
                      (i = s.groupBy),
                      (a = s.formatResult),
                      (u = e.getQuery(e.currentValue)),
                      (l = e.classes.suggestion),
                      (t = e.classes.selected),
                      (n = d(e.suggestionsContainer)),
                      (o = d(e.noSuggestionsContainer)),
                      (r = s.beforeRender),
                      (c = ""),
                      s.triggerSelectOnValidInput && e.isExactMatch(u)
                          ? e.select(0)
                          : (d.each(e.suggestions, function (e, t) {
                            ...
                            n.html(c),
                            "function" == typeof r &&
                                r.call(e.element, n, e.suggestions),
                            e.fixPosition(),
                            n.show(),
                            s.autoSelectFirst &&
                                ((e.selectedIndex = 0),
            ...
            noSuggestions: function () {
                ...
                this.adjustContainerWidth(),
                    ...
                    n.append(o),
                    "function" == typeof t &&
                        t.call(e.element, n, e.suggestions),
                    e.fixPosition(),
                    n.show(),
                    (e.visible = !0);
            },
            ...
            activate: function (e) {
                ...
                return (
                    ...
                    -1 !== t.selectedIndex && s.length > t.selectedIndex
                        ? ((o = s.get(t.selectedIndex)), d(o).addClass(n), o)
                        : null
                );
            },
            selectHint: function () {
            ...
            adjustScroll: function (e) {
                ...
                i &&
                    ...
                    (i = i.offsetTop),
                    (o =
                        (n = d(s.suggestionsContainer).scrollTop()) +
                        s.options.maxHeight -
                        t),
                    i < n
                        ? d(s.suggestionsContainer).scrollTop(i)
                        : o < i &&
                          d(s.suggestionsContainer).scrollTop(
                              i - s.options.maxHeight + t
                          ),
